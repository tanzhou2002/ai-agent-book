...
- **إذا كنت مطور وكلاء**، فاقرأ الفصول من 1 إلى 8 بالترتيب: تعرض الفصول الخمسة الأولى أساليب البناء، ويضع الفصل السادس أسس التقييم، ويشرح الفصل السابع تدريب النماذج، ويجمع الفصل الثامن تحديث المعاملات وسائر مسارات التحديث في حلقة متكاملة للتطور المستمر. ويمكنك قراءة الفصلين 9 و10 بحسب حاجتك إلى التفاعل متعدد الوسائط أو التعاون بين وكلاء متعددين.
...
- **إذا كان تركيزك منصبًا على تدريب النماذج**، فانتقل مباشرة إلى الفصل السابع (مرحلة ما بعد تدريب النموذج). ولأن طرق التقييم الواردة في الفصل السادس تُعد شرطًا أساسيًا للتدريب، يُستحسن قراءتهما معًا بعد استكمال الفصلين الأول والثاني.
...
- **أساسيات التعلم الآلي** (الفصل 7): فهم المفاهيم الأساسية مثل التدريب مقابل الاستدلال، ودوال الخسارة، والانحدار التدريجي، والتجهيز الزائد (Overfitting).
- **الرياضيات الأساسية** (الفصول 2-3، 7): فهم بديهي للجبر الخطي (تمثيل المتجهات ورسم المصفوفات) ودوال الاحتمالات الإحصائية لتقييم المكافآت في التعلم المعزز.
...
- **الفهم الأساسي لبنية المحولات (Transformer)** (الفصول 2، 7): بنية Transformer هي العمود الفقري لجميع النماذج اللغوية الكبيرة.
